...
const FENGSHUI_LEFT_PANEL_DATA = {
  panelTitleZh: '风水方位盘',
  panelTitleEn: 'Feng Shui Compass',
  panelDescZh: '通过方位、围合与依托关系理解当前格局区域在宫城中的风水角色。',
  panelDescEn: 'Read the current palace zone through direction, enclosure, and support.',
  defaultMode: 'front',
  compass: {
    centerDefaultZh: '中',
    centerDefaultEn: 'Center',
    summaryDefaultZh: '中轴定序，八方成局',
    summaryDefaultEn: 'The axis settles the center and orders the eight directions.',
  },
  modes: {
    front: {
      id: 'front',
      titleZh: '前场明堂',
      titleEn: 'Bright Forecourt',
      subtitleZh: '开阔前场，纳势入宫',
      subtitleEn: 'Open forecourt gathers momentum inward',
      accent: '#C9A34A',
      accentSoft: 'rgba(201,163,74,0.16)',
      accentGlow: 'rgba(201,163,74,0.28)',
      compassState: {
        centerTextZh: '明堂',
        centerTextEn: 'Hall',
        focusDirections: ['southeast', 'south', 'southwest'],
        focusTrigrams: ['xun', 'li', 'kun'],
        glowRing: 'south-arc',
        axisLine: 'south-to-center',
        particleFlow: 'from-south',
      },
      tagsZh: ['开阔引势', '南向昭示', '入宫有序'],
      tagsEn: ['Open approach', 'South-facing reveal', 'Ordered entry'],
      shortNoteZh: '前区空间舒展，形成礼序展开的第一视觉场。',
      shortNoteEn: 'The southern forecourt opens wide to form the first ceremonial field of vision.',
      detailZh: '强调宫城前场的开敞性与迎入感，画面应表现为南向空间被打开，气线自前场缓缓汇入中心，体现“先开后聚”的格局节奏。',
      detailEn: 'This mode stresses openness and reception: the southern approach unfolds first, then gently channels momentum toward the center.',
      footerSummaryZh: '前场开阔，纳势入宫',
      footerSummaryEn: 'The forecourt opens and draws momentum inward.',
      footerBadgesZh: ['景势外展', '礼序先行', '纳势有门'],
      footerBadgesEn: ['Scenery unfolds', 'Ritual begins first', 'Momentum enters in order'],
    },
    water: {
      id: 'water',
      titleZh: '水脉导气',
      titleEn: 'Water Guidance',
      subtitleZh: '借水导势，缓冲入宫',
      subtitleEn: 'Water guides and softens the inward flow',
      accent: '#55A9D9',
      accentSoft: 'rgba(85,169,217,0.16)',
      accentGlow: 'rgba(85,169,217,0.24)',
      compassState: {
        centerTextZh: '导气',
        centerTextEn: 'Guide',
        focusDirections: ['southeast', 'south'],
        focusTrigrams: ['xun', 'li'],
        glowRing: 'flow-arc',
        axisLine: 'southeast-to-center',
        particleFlow: 'arc-flow',
      },
      tagsZh: ['缓冲导流', '柔势入场', '气线连贯'],
      tagsEn: ['Buffered guidance', 'Soft entrance', 'Continuous qi line'],
      shortNoteZh: '以柔和导线模拟气流或水势，引导空间节奏向中心过渡。',
      shortNoteEn: 'Gentle guiding lines suggest water or qi, easing the rhythm toward the center.',
      detailZh: '这一层不强调猛烈聚集，而强调“引”“缓”“顺”，用弧形流线与轻粒子表现外部气脉被梳理后导入中心，形成柔性过渡。',
      detailEn: 'Rather than forceful convergence, this mode emphasizes guidance, buffering, and smooth transition through arcs and light particles.',
      footerSummaryZh: '借水导势，缓冲入宫',
      footerSummaryEn: 'Water guides momentum and buffers the entry.',
      footerBadgesZh: ['水线导入', '收放有度', '气脉顺行'],
      footerBadgesEn: ['Waterline guidance', 'Measured release', 'Qi flows smoothly'],
    },
    guard: {
      id: 'guard',
      titleZh: '左右护持',
      titleEn: 'Side Guard',
      subtitleZh: '两翼拱卫，中轴得稳',
      subtitleEn: 'Flanking wings stabilize the central axis',
      accent: '#8A7BAF',
      accentSoft: 'rgba(138,123,175,0.15)',
      accentGlow: 'rgba(138,123,175,0.22)',
      compassState: {
        centerTextZh: '护持',
        centerTextEn: 'Guard',
        focusDirections: ['east', 'west'],
        focusTrigrams: ['zhen', 'dui'],
        glowRing: 'left-right',
        axisLine: 'horizontal-balance',
        particleFlow: 'dual-side-in',
      },
      tagsZh: ['两翼夹护', '中轴稳固', '侧向均衡'],
      tagsEn: ['Twin flank support', 'Stable axis', 'Lateral balance'],
      shortNoteZh: '左右形成视觉支撑，使中心秩序更稳定。',
      shortNoteEn: 'East and west act as visual buttresses, making the center feel more secure.',
      detailZh: '通过左右两侧对称高亮与呼吸脉冲，表达“左辅右弼、两翼拱卫”的围护关系，强调中轴不是孤立存在，而是被两侧空间共同稳定。',
      detailEn: 'Symmetric pulses on both sides express bilateral support, showing that the axis is stabilized by the surrounding wings rather than standing alone.',
      footerSummaryZh: '两翼拱卫，中轴得稳',
      footerSummaryEn: 'The wings support one another and steady the axis.',
      footerBadgesZh: ['左右成屏', '两翼均衡', '中轴受护'],
      footerBadgesEn: ['Screening flanks', 'Balanced wings', 'Axis protected'],
    },
    back: {
      id: 'back',
      titleZh: '后靠聚势',
      titleEn: 'Rear Support',
      subtitleZh: '后枕收束，格局有靠',
      subtitleEn: 'Rear support anchors and concludes the layout',
      accent: '#58B26B',
      accentSoft: 'rgba(88,178,107,0.16)',
      accentGlow: 'rgba(88,178,107,0.24)',
      compassState: {
        centerTextZh: '有靠',
        centerTextEn: 'Backed',
        focusDirections: ['northwest', 'north', 'northeast'],
        focusTrigrams: ['gen', 'qian', 'kan'],
        glowRing: 'north-arc',
        axisLine: 'north-anchor',
        particleFlow: 'back-anchor',
      },
      tagsZh: ['后枕有靠', '收束归静', '格局闭合'],
      tagsEn: ['Backed rear', 'Gathering to stillness', 'Closed pattern'],
      shortNoteZh: '后方稳定收束，为整体空间提供依托与归定感。',
      shortNoteEn: 'The rear gathers and settles, giving the entire sequence a clear support.',
      detailZh: '后场强调“靠”与“收”，不是继续外放，而是让气势在后方形成承接与锚定，视觉上应更稳、更静、更厚，形成完整格局闭环。',
      detailEn: 'The rear does not continue to expand outward. Instead, it receives and anchors the momentum, making the visual language quieter, steadier, and heavier.',
      footerSummaryZh: '后枕收束，格局有靠',
      footerSummaryEn: 'The rear gathers in and gives the pattern a backing.',
      footerBadgesZh: ['景山为靠', '收束归静', '稳势锚定'],
      footerBadgesEn: ['Hill as backing', 'Gathering to rest', 'Momentum anchored'],
    },
  },
}
